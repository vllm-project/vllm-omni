...
class NPUARModelRunner(OmniNPUModelRunner):
    ...
    def _prepare_inputs(
        ...
        intermediate_tensors: Optional[IntermediateTensors] = None,
               ...
               Optional[torch.Tensor], Optional[torch.Tensor], int, dict[str, dict] | None]:
        ...
        return (attn_metadata, positions, num_scheduled_tokens,
                ...
                max_num_scheduled_tokens, per_req_additional_information)
    ...
    def execute_model(
        ...
        with ProfileExecuteDuration().capture_async("prepare input"):
            ...
            (attn_metadata, positions, num_scheduled_tokens_np,
             ...
             max_query_len, per_req_additional_information) = (self._prepare_inputs(scheduler_output,
                                                    intermediate_tensors))
        ...
        with ProfileExecuteDuration().capture_async("forward"):
            with set_ascend_forward_context(
                ...
                hidden_states = self._generate_process_reqs_hidden_states(
                    ...
                    input_ids, positions, intermediate_tensors, inputs_embeds, model_kwargs_extra)
    ...
    def _generate_process_reqs_hidden_states(self, attn_metadata, with_prefill,
                                             ...
                                             input_ids, positions,
                                             intermediate_tensors,
                                             inputs_embeds, model_kwargs_extra):
