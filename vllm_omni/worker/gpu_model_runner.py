...
class OmniGPUModelRunner(GPUModelRunner):
    ...
    def _build_model_kwargs_extra(self) -> dict:
        ...
        - request_token_spans: per-request (start, end) spans in flattened step input
        - runtime_req_ids: request ids aligned with request_token_spans
        """
        ...
        try:
            ...
            num_scheduled_tokens_np = self._omni_num_scheduled_tokens_np
            if num_scheduled_tokens_np is not None:
                ...
                model_kwargs_extra["runtime_req_ids"] = list(self.input_batch.req_ids)
        except Exception as e:
