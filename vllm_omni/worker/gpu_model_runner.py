...
from vllm_omni.worker.model_input_metadata import (
    AsyncSampledTokenFeedback,
    resolve_async_sampled_token_ids_cpu,
)
...
class OmniGPUModelRunner(GPUModelRunner):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._omni_async_sampled_token_feedback: AsyncSampledTokenFeedback | None = None
    ...
    def _remember_async_sampled_token_feedback(
        ...
        *,
        ...
        if not (
            ...
            self._omni_async_sampled_token_feedback = None
            return
        self._omni_async_sampled_token_feedback = AsyncSampledTokenFeedback(
    ...
    def _scheduled_input_token_ids_cpu(
        ...
        *,
        ...
        return resolve_async_sampled_token_ids_cpu(
