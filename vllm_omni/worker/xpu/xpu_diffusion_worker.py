...
from vllm_omni.worker.xpu.xpu_diffusion_model_runner import XPUDiffusionModelRunner


class XPUDiffusionWorker(XPUWorker):
    ...
    def init_device(self):
        ...
        self.model_runner: XPUDiffusionModelRunner = XPUDiffusionModelRunner(self.vllm_config, self.device)
