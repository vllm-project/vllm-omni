...
from vllm_omni.diffusion.model_config_loader import populate_diffusion_model_config
...
class AsyncOmniDiffusion:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Keep entrypoint initialization lean by delegating model config resolution.
        populate_diffusion_model_config(od_config)
