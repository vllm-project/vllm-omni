...
def load_global_config(config_data: DictConfig) -> tuple[str | None, DictConfig | None]:
    ...
    Returns:
        A tuple containing:
            - global_policy (str | None): The name of the scheduling policy (e.g., 'fcfs', 'priority').
            - policy_config (DictConfig | None): The sub-configuration specific to the identified policy.
    """
    global_policy = None
    policy_config = None
...
def validate_scheduler_for_stage(
    ...
    Args:
        stage_arg: Configuration specific to the current execution stage.
        base_engine_args_tmp: The base engine configuration object to be updated.
        global_policy: The identifier of the global scheduling policy.
