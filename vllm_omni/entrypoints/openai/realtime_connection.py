...
from vllm.entrypoints.speech_to_text.connection import RealtimeConnection as VllmRealtimeConnection
from vllm.entrypoints.speech_to_text.protocol import TranscriptionDelta, TranscriptionDone
