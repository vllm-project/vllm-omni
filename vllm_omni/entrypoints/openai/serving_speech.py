...
class OmniOpenAIServingSpeech(OpenAIServing, AudioMixin):
    ...
    async def _generate_audio_chunks(
        ...
        scalar/Tensor/array payloads are emitted once per engine update (or
        only their new samples when cumulative_audio is set for requests that
        retain audio for alignment).
