...
class MammothModa2Qwen2ForCausalLM(nn.Module, SupportsPP):
    ...
    def get_input_embeddings(self, input_ids: torch.Tensor) -> torch.Tensor:
        ...
        # sampled token has not been written back yet. Clamp negatives to 0 so
        # both gather paths below (and the short-circuit branch on TP=1) stay
        # in-bounds; the scheduler overwrites those positions before they can
        # influence downstream output.
