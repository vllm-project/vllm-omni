    ...
    def forward(
        ...
        **kwargs: object,
        ...
        # condition is for v0 compatibility.
            ...
            text_inputs_embeds = self.get_input_embeddings(input_ids, [(torch.zeros_like(embeddings), modality) for embeddings, modality in multimodal_embeddings] if multimodal_embeddings is not None else None)
            input_ids = None
        else:
