...
class EncDecCTCModel(ASRModel, ExportableEncDecModel):
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0, decode_results=None):
        ...
        self._wer.update(
            predictions=predictions, targets=transcript, target_lengths=transcript_len, decode_results=decode_results,
            predictions_lengths=encoded_len, log_prediction=batch_idx < 3)
    ...
    def multi_test_epoch_end(self, outputs, dataloader_idx: int = 0):
        ...
        res = super().multi_test_epoch_end(outputs, dataloader_idx)
        res['decode_results'] = (references, hypotheses)
        return res
