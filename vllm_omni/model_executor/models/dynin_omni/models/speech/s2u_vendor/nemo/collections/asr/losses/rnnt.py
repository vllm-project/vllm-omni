...
class RNNTLoss(Loss):
    ...
    def __init__(self, blank_idx, reduction: str = 'mean_batch', loss_name: str = "default", loss_kwargs=None):
        """
        ...
        Args:
            blank_idx: Number of target classes for the joint network to predict.
    ...
    def forward(self, log_probs, targets, input_lengths, target_lengths):
        ...
        if targets.shape[1] != max_targets_len:
            raise ValueError('targets len do not match targets')
