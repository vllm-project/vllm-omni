...
class Wav2VecTransformerConfig:
    ...
    encoder: Wav2VecTransformerEncoderConfig = field(default_factory=Wav2VecTransformerEncoderConfig)
...
class Wav2VecEncoderModelConfig:
    ...
    conv_feature_encoder: ConvFeatureEncoderConfig = field(default_factory=ConvFeatureEncoderConfig)
    transformer_encoder: Wav2VecTransformerConfig = field(default_factory=Wav2VecTransformerConfig)
    masking: Wav2VecMaskingConfig = field(default_factory=Wav2VecMaskingConfig)
