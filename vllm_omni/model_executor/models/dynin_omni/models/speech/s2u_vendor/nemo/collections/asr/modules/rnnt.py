...
class RNNTJoint(rnnt_abstract.AbstractRNNTJoint):
    ...
    def __init__(
        ...
        blank_pos: str = 'after_vocab_last',
        init_mode='torch_default', bias_init_mode='torch_default'
    ):
        super().__init__()
        ...
        if blank_pos == 'after_vocab_last':
            ...
            assert blank_pos in ['vocab_first', 'vocab_last']
        ...
        single_bias = jointnet.get('single_bias', False)
    ...
    def forward(
        ...
        decode_results: Optional[dict] = None,
            ...
            for batch_idx in range(0, batch_size, self._fused_batch_size):
                ...
                if compute_wer:
                    ...
                    self.wer.update(sub_enc, sub_enc_lens, sub_transcripts, sub_transcript_lens,
                                    decode_results=decode_results, log_prediction=log_prediction)
    ...
    def joint(self, f: torch.Tensor, g: torch.Tensor, apply_softmax=False) -> torch.Tensor:
        """
    ...
    def _joint_net(self, num_classes, pred_n_hidden, enc_n_hidden, joint_n_hidden, activation, dropout, single_bias):
        """
        ...
        enc = torch.nn.Linear(enc_n_hidden, joint_n_hidden, bias=False if single_bias else True)
