...
from vllm_omni.model_executor.models.minicpmo_2_6.minicpmo_2_6_omni_llm import MiniCPMOConfig
...
class MiniCPMO26OmniForConditionalGeneration(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.model_stage == "llm":
            ...
            self.thinker = init_vllm_registered_model(
                ...
                architectures=["MiniCPMO26OmniLLMModel"],
            )
            ...
            self.talker = init_vllm_registered_model(
                ...
                hf_config=config,
                # Use registry architecture key
                architectures=["MiniCPMO26OmniTTSModel"],
            )
            ...
            self.code2wav = init_vllm_registered_model(
                ...
                architectures=["MiniCPMO26OmniT2WModel"],
            )
