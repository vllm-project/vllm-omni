...
HUNYUAN_IMAGE3_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="hunyuan_image_3_moe.yaml",
...
HUNYUAN_IMAGE3_AR_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="hunyuan_image3_ar.yaml",
    model_arch=_HUNYUAN_IMAGE3_MODEL_ARCH,
    hf_architectures=(),
    stages=(
        StagePipelineConfig(
...
HUNYUAN_IMAGE3_DIT_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="hunyuan_image3_dit.yaml",
    model_arch=_HUNYUAN_IMAGE3_MODEL_ARCH,
    hf_architectures=(),
    stages=(
        StagePipelineConfig(
