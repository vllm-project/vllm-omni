...
class AuraServingSessionState(DuplexModelSessionState):
    """Per-session AURA duplex state (owned by SessionRunner)."""

    audio_buffer: AuraPcmAppendBuffer = field(default_factory=AuraPcmAppendBuffer)
...
__all__ = ["AuraServingSessionState"]
