    ...
    def preprocess(
        ...
        **info_dict: Any,
        ...
        if span_len > 1:
            ...
            prompt_embeds_cpu = info_dict.get("embed.prefill")
            tts_pad_embed_cpu = info_dict.get("embed.tts_pad")
            tts_pad_embed = None
        ...
        tail_cpu = info_dict.get("hidden_states.trailing_text")
        ...
        last_hidden_cpu = info_dict.get("hidden_states.last")
