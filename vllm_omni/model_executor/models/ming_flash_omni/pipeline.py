...
MING_FLASH_OMNI_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="ming_flash_omni.yaml",
...
MING_FLASH_OMNI_TTS_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="ming_flash_omni_tts.yaml",
    model_arch="MingFlashOmniTalkerForConditionalGeneration",
    stages=(
        StagePipelineConfig(
            stage_id=0,
...
MING_FLASH_OMNI_THINKER_ONLY_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="ming_flash_omni_thinker_only.yaml",
    model_arch="MingFlashOmniForConditionalGeneration",
    stages=(
        StagePipelineConfig(
            stage_id=0,
...
MING_FLASH_OMNI_IMAGE_PIPELINE = PipelineConfig(
    ...
    default_deploy_config_path="ming_flash_omni_image.yaml",
    model_arch="MingFlashOmniForConditionalGeneration",
    stages=(
        StagePipelineConfig(
            stage_id=0,
