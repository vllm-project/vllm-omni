    ...
    def forward(
        ...
        if self._chunk_size is not None:
            ...
            if norm_hidden_states.shape[self._chunk_dim] % self._chunk_size != 0:
                raise ValueError(
                    f"`hidden_states` dimension to be chunked: "
                    f"{norm_hidden_states.shape[self._chunk_dim]} has to be divisible by "
                    f"chunk size: {self._chunk_size}. Make sure to set an appropriate "
