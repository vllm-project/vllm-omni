...
_CLASS_TO_MODULE: dict[str, str] = {
    ...
    "FunCineForgeConfig": "vllm_omni.transformers_utils.configs.funcineforge",
...
from vllm_omni.transformers_utils.configs import funcineforge as _funcineforge  # noqa: F401, E402
