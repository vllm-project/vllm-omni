...
* Load-time pack (`svdquant_nunchaku.prepare_weights`): for the nunchaku
  kernel backend, repack the row-major on-disk tensors into fragment
  layout before the kernel sees them.
