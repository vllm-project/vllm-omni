...
class PipelineConfig:
    ...
    # Bundled deploy defaults for this concrete pipeline topology. Bare file
    # names resolve under vllm_omni/deploy; None uses DeployConfig defaults.
    default_deploy_config_path: str | None = None
