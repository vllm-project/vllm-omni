...
from vllm_omni.model_executor.models.qwen3_asr.pipeline import (
    QWEN3_ASR_ALIGN_PIPELINE,
    QWEN3_ASR_PIPELINE,
)
...
OMNI_PIPELINES: dict[str, PipelineConfig | PipelineResolverFunc] = {
    ...
    "qwen3_asr": QWEN3_ASR_PIPELINE,
    "qwen3_asr_align": QWEN3_ASR_ALIGN_PIPELINE,
