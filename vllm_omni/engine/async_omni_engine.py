...
class AsyncOmniEngine:
    ...
    def _create_default_diffusion_stage_cfg(kwargs: dict[str, Any]) -> list:
        ...
        stage_engine_args = {
            ...
            "vae_optimization_profile": kwargs.get("vae_optimization_profile", "safe"),
            "vae_stack_tiling": kwargs.get("vae_stack_tiling"),
            "vae_compile": kwargs.get("vae_compile"),
            "vae_compile_max_shape_buckets": kwargs.get("vae_compile_max_shape_buckets", 4),
