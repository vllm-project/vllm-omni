...
class MultimodalOutputProcessor(VLLMOutputProcessor):
    ...
    def process_outputs(
        self,
        engine_core_outputs: list[OmniEngineCoreOutput],
    ...
    # ---- routing helpers ----
    def _route_and_normalize(self, eco: OmniEngineCoreOutput) -> None:
        output_type = (getattr(eco, "output_type", None) or "").lower()
    ...
    # ---- modality processors ----
    def _process_image_output(self, eco: OmniEngineCoreOutput) -> None:
    ...
    def _process_text_image_output(self, eco: OmniEngineCoreOutput) -> None:
    ...
    def _process_latents_output(self, eco: OmniEngineCoreOutput) -> None:
    ...
    def _process_audio_output(self, eco: OmniEngineCoreOutput) -> None:
    ...
    def _process_text_output(self, eco: OmniEngineCoreOutput) -> None:
        """No-op; base processor will detokenize new_token_ids → text."""
        return

    def _process_pooling_output(self, eco: OmniEngineCoreOutput) -> None:
    ...
    def _extract_from_multimodal_outputs(
        self, eco: OmniEngineCoreOutput, keys: tuple[str, ...]
