...
from vllm_omni.diffusion.distributed.autoencoders.autoencoder_kl import DistributedAutoencoderKL_NextStep
    ...
    def __init__(
        ...
        *,
        ...
        if os.path.exists(vae_path):
            self.vae = DistributedAutoencoderKL_NextStep.from_pretrained(vae_path)
        else:
            ...
            if os.path.exists(vae_checkpoint) and os.path.exists(vae_config):
                self.vae = DistributedAutoencoderKL_NextStep.from_pretrained(os.path.join(model_path, "vae"))
            else:
