    ...
    def forward(
        ...
        *,
        ...
        if isinstance(cache, ARDiffusionPagedLayerInputs):
            ...
            if query.is_npu and query.shape[0] == 1:
                # NPU direct replay: gather the visible window and run the
                # same fused kernel as the paged path so replay stays a
                # numerical oracle for paged execution on this device too.
            ...
            elif query.is_cuda and query.shape[0] == 1:
