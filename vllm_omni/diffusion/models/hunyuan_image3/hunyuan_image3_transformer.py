...
# ResBlock is platform-dispatched in the package __init__: CUDA gets fused
# GroupNorm+SiLU and AdaGN kernels, every other backend gets the plain PyTorch
# block. UNetDown and UNetUp below instantiate whichever one this resolves to.
from vllm_omni.diffusion.models.hunyuan_image3 import ResBlock
