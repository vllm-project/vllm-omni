...
"""Compatibility alias for :mod:`vllm_omni.diffusion.models.pi.pi0`."""
...
_CANONICAL_PACKAGE = "vllm_omni.diffusion.models.pi.pi0"
_legacy_package = __name__
_canonical = importlib.import_module(_CANONICAL_PACKAGE)

for _submodule in ("config", "modeling_pi0", "pipeline_pi0", "processor_pi0"):
