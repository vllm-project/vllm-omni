...
class CausalWanSelfAttention(nn.Module):
    ...
    def forward(
        ...
        kv_cache[CacheIndex.K][:, current_start:current_end] = roped_key
        kv_cache[CacheIndex.V][:, current_start:current_end] = v

        k_cache = kv_cache[CacheIndex.K][:, 0:current_end]
        v_cache = kv_cache[CacheIndex.V][:, 0:current_end]
