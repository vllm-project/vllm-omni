...
def swiglu7(
    ...
    # Keep the native expression visible to torch.compile even when the
    # eager fused path is enabled for inference.
    if not torch.compiler.is_compiling() and os.environ.get("MAGI2_USE_FUSED_SWIGLU7", "0") == "1":
