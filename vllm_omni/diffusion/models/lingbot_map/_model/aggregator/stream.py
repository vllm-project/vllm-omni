...
from vllm_omni.diffusion.models.lingbot_map._model.layers.block import Block, FlashInferBlock, SDPABlock
from vllm_omni.diffusion.models.lingbot_map._model.layers.rope import WanRotaryPosEmbed
from vllm_omni.diffusion.models.lingbot_map._model.aggregator.base import AggregatorBase, slice_expand_and_flatten
...
class AggregatorStream(AggregatorBase):
    ...
    def _get_flashinfer_manager(self, device, dtype, tokens_per_frame=None):
        ...
        if self.kv_cache_manager is None:
            from vllm_omni.diffusion.models.lingbot_map._model.layers.flashinfer_cache import FlashInferKVCacheManager
