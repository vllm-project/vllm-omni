...
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.common.normalization import PixelNorm
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.types import (
    VIDEO_SCALE_FACTORS,
    SpatioTemporalScaleFactors,
    VideoLatentShape,
)
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.video_vae.convolution import make_conv_nd
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.video_vae.enums import (
    LogVarianceType,
    NormLayerType,
    PaddingModeType,
)
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.video_vae.ops import PerChannelStatistics, patchify, unpatchify
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.video_vae.resnet import ResnetBlock3D, UNetMidBlock3D
from vllm_omni.diffusion.models.joyai_echo.ltx_core_vae.video_vae.sampling import (
...
class VideoEncoder(nn.Module):
    ...
    def __init__(
        ...
        for block_name, block_params in encoder_blocks or []:
...
class VideoDecoder(nn.Module):
    ...
    def __init__(
        ...
        for block_name, block_params in list(reversed(decoder_blocks or [])):
            # Convert int to dict format for uniform handling
            block_config = {"num_layers": block_params} if isinstance(block_params, int) else block_params
