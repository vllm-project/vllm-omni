...
def _wrap_method_with_offload(module: nn.Module, method_name: str, 
                               exec_device: torch.device, pin_memory: bool) -> None:
    ...
    def wrapped_method(*args, **kwargs):
        ...
        logger.debug("Method wrap: moved %s to %s for %s()", 
                    module.__class__.__name__, exec_device, method_name)
        try:
