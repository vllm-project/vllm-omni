...
def initialize_model(
    ...
    if model_class is not None:
        ...
        if hasattr(model, "vae") and hasattr(od_config, "parallel_config"):
            ...
            from vllm_omni.diffusion.vae.decode_profiler import maybe_install_vae_decode_profiler
            ...
            maybe_install_vae_decode_profiler(
                model,
                enabled=od_config.enable_vae_profiling,
                group_getter=get_dit_group,
            )
