...
def get_cache_backend(cache_backend: str | None, cache_config: Any) -> CacheBackend | None:
    ...
    Args:
        cache_backend: Cache backend name. Supported values:
            "cache_dit", "tea_cache", "mag_cache", "sea_cache",
            "step_cache", "inter_request", "inter_request+cache_dit"
            (or "cache_dit+inter_request"), or None.
    ...
    if cache_backend == "cache_dit":
        ...
        raise ValueError(
            ...
            "Supported: 'cache_dit', 'tea_cache', 'mag_cache', 'sea_cache', "
            "'step_cache', 'inter_request', 'inter_request+cache_dit'"
        )
