...
# Preserve H3 half-split fast-path geometry; this does not limit the
# interleaved mode or other valid inputs handled by eager dispatch.
_FUSED_HEAD_DIM = 128
_FUSED_ROTARY_DIM = 96
# Interleaved-mode geometry bounds (any even rotary_dim <= head_dim <= this).
_FUSED_MAX_HEAD_DIM = 256
# Triton tiling only; head counts need not be multiples of this value.
...
if HAS_TRITON:
    ...
    def _rms_norm_rope_kernel(
        ...
        # 长视频的 Q/K view 可跨越 fused QKV storage 中超过 2**31 个元素。
