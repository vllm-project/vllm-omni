...
from vllm_omni.platforms.npu._310p.qwen3_tts_runtime import use_qwen3_tts_talker_310p_path
...
class OmniNPUModelRunner(OmniGPUModelRunner, NPUModelRunner):
    def load_model(self, *args, **kwargs) -> None:
        if use_qwen3_tts_talker_310p_path(self.model_config):
            from vllm_omni.platforms.npu._310p.patch import apply_qwen3_tts_talker_patches

            apply_qwen3_tts_talker_patches()
