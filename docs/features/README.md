...
| Split the two Cosmos3 Mixture-of-Transformers towers across GPUs (text-to-image only, experimental) | [Cosmos3 Tower Disaggregation](cosmos3_tower_disaggregation.md) | [Disaggregated Inference](../design/feature/disaggregated_inference.md), [Pipeline and deploy configurations](../configuration/stage_configs.md) |
