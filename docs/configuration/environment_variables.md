...
The audit found 62 variables read by a single model or pipeline family. They are
...
| Deprecate/remove | 2 | Remove a compatibility escape hatch that has no continuing contract. |
