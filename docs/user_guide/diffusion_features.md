...
> 8. SenseNova-U1 / U1.5 supports single-request step execution only; use `max_num_seqs=1`. Think, text-to-text and image-to-text decode run as a resumable prepare phase; see [Diffusion Execution Modes](diffusion/execution_modes.md#step-execution).
