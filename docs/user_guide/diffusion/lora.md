...
For supported artifacts, sampling schedules, and offload compatibility, see
the [MiniMax-H3 LoRA recipe](https://github.com/vllm-project/vllm-omni/blob/main/recipes/MiniMaxAI/MiniMax-H3.md#lora).
The [FastH3 adapter](https://github.com/vllm-project/vllm-omni/blob/main/recipes/MiniMaxAI/MiniMax-H3.md#fasth3-adapter)
uses a separate startup-fusion path.
