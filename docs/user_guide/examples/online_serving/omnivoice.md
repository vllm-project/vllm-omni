...
Source <https://github.com/vllm-project/vllm-omni/tree/main/examples/online_serving/omnivoice>.
...
??? abstract "run_server.sh"
    ``````sh
    --8<-- "examples/online_serving/omnivoice/run_server.sh"
    ``````
??? abstract "speech_client.py"
    ``````py
    --8<-- "examples/online_serving/omnivoice/speech_client.py"
    ``````
