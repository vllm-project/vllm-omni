...
Source <https://github.com/vllm-project/vllm-omni/tree/main/examples/online_serving/voxcpm2>.
...
??? abstract "gradio_demo.py"
    ``````py
    --8<-- "examples/online_serving/voxcpm2/gradio_demo.py"
    ``````
??? abstract "openai_speech_client.py"
    ``````py
    --8<-- "examples/online_serving/voxcpm2/openai_speech_client.py"
    ``````
