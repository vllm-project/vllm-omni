...
Source <https://github.com/vllm-project/vllm-omni/tree/main/examples/online_serving/voxcpm>.
...
??? abstract "openai_speech_client.py"
    ``````py
    --8<-- "examples/online_serving/voxcpm/openai_speech_client.py"
    ``````
??? abstract "run_server.sh"
    ``````sh
    --8<-- "examples/online_serving/voxcpm/run_server.sh"
    ``````
