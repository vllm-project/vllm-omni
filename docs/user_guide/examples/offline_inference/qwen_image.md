...
??? abstract "gradio_demo.py"
    ``````py
    --8<-- "/mnt/vllm_open_release/vllm-omni-public/vllm-omni/examples/offline_inference/qwen_image/gradio_demo.py"
    ``````
??? abstract "text_to_image.py"
    ``````py
    --8<-- "/mnt/vllm_open_release/vllm-omni-public/vllm-omni/examples/offline_inference/qwen_image/text_to_image.py"
    ``````
