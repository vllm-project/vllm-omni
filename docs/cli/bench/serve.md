...
The opt-in accuracy runner rejects HTTP failures, duplicate question IDs, and missing gold
answers, so oversampling cannot turn incomplete coverage into a passing accuracy check.
