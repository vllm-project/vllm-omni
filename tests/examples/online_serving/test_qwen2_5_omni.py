...
def test_send_multimodal_request_001(omni_server) -> None:
    ...
    assert (
        "lamb" in text_content
    ), "The output does not contain any of the keywords in audio description."
