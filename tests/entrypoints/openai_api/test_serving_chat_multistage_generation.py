...
def test_build_multistage_generation_inputs_sets_ar_stage_stop_token_ids_with_explicit_size(serving_chat):
...
def test_build_multistage_generation_inputs_no_stop_token_ids_without_size(serving_chat):
    ...
    Without bot_task at all, ar_stage_stop_token_ids stays None and
    ...
    # No height/width, no bot_task -> ar_stage_stop_token_ids=None ->
