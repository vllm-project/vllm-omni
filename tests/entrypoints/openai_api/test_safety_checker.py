...
# Load SafetyChecker without triggering vllm_omni.__init__ (vllm._C import)
...
SafetyChecker = _mod.SafetyChecker
...
def _make_checker_with_mock_pipeline(side_effect):
...
class TestSafetyChecker:
    ...
    def test_check_images_reuses_pipeline(self):
