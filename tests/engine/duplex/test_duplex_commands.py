...
_MINIMAL_PAYLOADS: dict[str, tuple[dict[str, object], type[DuplexCommand]]] = {
    ...
    "conversation.item.retrieve": ({"item_id": "item_1"}, SignalTurn),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"type": "conversation.item.delete"}, "bad_event"),
        ({"type": "conversation.item.delete", "item_id": ""}, "bad_event"),
        ({"type": "conversation.item.truncate", "audio_end_ms": 1}, "bad_event"),
        ({"type": "conversation.item.truncate", "item_id": "", "audio_end_ms": 1}, "bad_event"),
        ({"type": "conversation.item.truncate", "item_id": "item_1"}, "bad_event"),
        (
            {"type": "conversation.item.truncate", "item_id": "item_1", "audio_end_ms": 100, "content_index": "bad"},
            "bad_event",
        ),
        ({"type": "response.cancel", "response_id": 123}, "bad_event"),
        ({"type": "conversation.item.retrieve", "item_id": 123}, "bad_event"),
