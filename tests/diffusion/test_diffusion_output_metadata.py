...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"actions": {"horizon": 0}}, ValueError),
        ({"actions": {"action_horizon": 0}}, ValueError),
        ({"actions": {"action_dim": 0}}, ValueError),
        ({"actions": {"valid_steps": -1}}, ValueError),
        ({"actions": {"action_space": ""}}, ValueError),
