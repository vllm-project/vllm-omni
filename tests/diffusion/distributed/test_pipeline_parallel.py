...
_L4_TWO_GPU = hardware_marks(res={"cuda": ["L4", "B200", "A100"]}, num_cards=2)
_L4_THREE_GPU = hardware_marks(res={"cuda": ["L4", "B200", "A100"]}, num_cards=3)
_L4_FOUR_GPU = hardware_marks(res={"cuda": ["L4", "B200", "A100"]}, num_cards=4)
