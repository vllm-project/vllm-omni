...
def test_predict_noise_with_labeled_inter_comm_ids(pp_size, cfg_size, dtype, do_true_cfg, num_calls, skip_sync, input_seed):
    ...
    torch.multiprocessing.spawn(
        predict_noise_worker,
        args=(world_size, port, pp_size, cfg_size, do_true_cfg, dtype, test_config, q, num_calls, skip_sync, inter_comm_ids),
        nprocs=world_size,
    )
