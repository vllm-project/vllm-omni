...
from vllm_omni.data_entry_keys import OmniPayloadStruct, serialize_payload
...
def _transfer_manager(
    *,
    ...
    return _TransferManager(connector=_Connector(config={"extra": extra}))
