...
def test_tool_direct_routing_uses_cumulative_ids_when_delta_is_only_terminator():
    ...
    extension = MiniCPMO45DuplexPlugin(lambda *args: None)
...
def test_context_versions_use_last_accumulated_value():
    ...
    from vllm_omni.model_executor.models.minicpmo_4_5.duplex.plugin import _special_token_ids as route_ids
