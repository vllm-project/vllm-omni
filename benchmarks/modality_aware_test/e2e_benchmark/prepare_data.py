    ...
    for modality, cfg in configs.items():
        ...
        try:
            ...
            for split_name in splits_to_load:
                ...
                if "name" in cfg: load_args["name"] = cfg["name"]
        ...
        for i, item in enumerate(ds):
            ...
            if cfg.get("dedup_key"):
                ...
                if uid is None and modality == "image": 
                    uid = item.get("iamge_id") or item.get("id")
...
if __name__ == "__main__":
    ...
    #   python3 vllm-omni/benchmarks/modality_aware_scheduling/prepare_data.py --data_dir /root/data/datasets --use_mainland_hf_mirror
    # for users in other regions:
    #   python3 vllm-omni/benchmarks/modality_aware_scheduling/prepare_data.py --data_dir /root/data/datasets
    ...
    parser.add_argument("--use_mainland_hf_mirror", action="store_true", 
                        help="Use hf-mirror.com for users in mainland China")
