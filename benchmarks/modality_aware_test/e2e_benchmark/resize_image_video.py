...
def main():
    ...
    parser.add_argument("--workers", type=int, default=min(16, multiprocessing.cpu_count()), help="Number of parallel workers")
...
if __name__ == "__main__":
    # python3 vllm-omni/benchmarks/modality_aware_scheduling/resize_image_video.py --data_dir /root/data/datasets
    main()
