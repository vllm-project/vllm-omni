...
def aggregate_stats(all_stats: list[dict]) -> dict:
    ...
    keys = [
        'thinker_tokens', 'thinker_time_s', 'thinker_tps',
        'talker_tokens', 'talker_time_s', 'talker_tps',
        'code2wav_tokens', 'code2wav_time_s', 'code2wav_tps',
        'total_tokens', 'total_time_s', 'total_tps'
    ]
