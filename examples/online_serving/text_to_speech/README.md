...
| VibeVoice | `microsoft/VibeVoice-1.5B` | ✓ (`ref_audio`, up to 4 speakers) | ✓ (raw PCM + SSE) | uploaded audio voice; [bundled defaults](../../../docs/design/vibevoice/ASSET_PROVENANCE.md) | — |
