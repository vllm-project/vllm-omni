...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a video with Wan2.1 T2V.")
    parser.add_argument(
        "--model",
        default="Wan-AI/Wan2.1-T2V-14B-Diffusers",
        help="Diffusers Wan2.1 model ID or local path.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=5.0,
        help="Scheduler flow_shift (typical values: 5.0 for 720p, 12.0 for 480p).",
    )
    parser.add_argument("--output", type=str, default="wan21_output.mp4", help="Path to save the video (mp4).")
...
def main():
    ...
    omni = Omni(
        ...
        model_class_name="Wan21Pipeline",
