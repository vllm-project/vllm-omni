...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model",
        default="causvid",
        help="Diffusers I2V model ID or local path",
    )
    parser.add_argument("--prompt", default="", help="Text prompt describing the desired motion.")
    parser.add_argument("--seed", type=int, default=42, help="Random seed.")
    parser.add_argument("--num-frames", type=int, default=21, help="Number of frames.")
    parser.add_argument("--output", type=str, default="caus_output.mp4", help="Path to save the video (mp4).")
...
def main():
    ...
    frames = [frame for frame in frames[0]]
